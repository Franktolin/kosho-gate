...
function checkoutRoot() {
  // The harness loads its bundled plugins from the profile's dependency tree
  // (DSH_HOME/profiles/node_modules), not from the source checkout's
  // node_modules. Patch targets must resolve there or every source patch
  // silently no-ops.
...
function apply(ctx) {
  ...
  if (root) {
    ...
    console.error("[kosho-gate] cannot locate harness checkout; source patches skipped");
  }
